...
class AssignedOrderList extends StatefulWidget {
  @override
  _AssignedOrderListState createState() => _AssignedOrderListState();
}

class _AssignedOrderListState extends State<AssignedOrderList> {
...
//to update the status to active orders
...
//get the data of assigned orders
                      ...
                      actions: <Widget>[
                        ...
                        Container(
                            ...
                            child: RaisedButton(
                              ...
                              onPressed: () {
                                // assigned order to activate order
                                updateToActiveStatus(
                                    assignee_id.toString(), 'Activated');
                              },
                            )),
                                                      ...
                                                      child: RaisedButton(
                                                        ...
                                                        onPressed: () {
                                                          Navigator.push(
                                                              context,
                                                              MaterialPageRoute(
                                                                  builder: (context) => AssignedOrderDetail(
                                                                      ...
                                                                      menuTitle01: menuTitle01,
                                                                      menuDescription01: menuDescription01,
                                                                      menuTitle02: menuTitle02,
                                                                      menuDescription02: menuDescription02,
